...
% Main new feature: Since we can now forecast states (as of Jan 2014), this is a
% more general program so that everything gets set correctly according to whether
% you're plotting/forecasting
%   - observables
%   - states
