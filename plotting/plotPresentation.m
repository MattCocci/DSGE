...
% FOR 828 MODELS (and, generally, non-510 models) MAKE SURE system=0
    ...
    for peachcount = peachloop
        ...
        for V_idx = 1:length(Vseq)
            ...
            if plotSeparate
                ...
                switch plotType
                    case {'Shock Decomposition','Forecast','Counterfactual by Variable'} % Figures that loop through variables
                        if any(strcmp(plotType,{'Forecast','Counterfactual by Variable'}))
            ...
            switch plotType
                ...
                case 'Shock Decomposition'
                    ...
                    % Adjustment for labor share TEMP %
%                      if V_a==3
%                          mlp_bar = 100*mlp_bar./repmat(0.5687,size(mlp_bar)); 
%                      end
                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    ...
                    % Adjustment for labor share TEMP %
%                      if V_a==3
%                          mlp = 100*mlp./repmat(0.5687,size(mlp));
%                      end
                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                case 'Counterfactual by Variable'
                    ...
                    for S_1 = 1:length(Shseq)
                        ...
                        if plotSeparate
                            ...
                            subplot(ceil(length(Shseq)/2),2,S_1)
                        end
